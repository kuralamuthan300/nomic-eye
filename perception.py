...
SYSTEM = (
    ...
    "Plan the goals efficiently, if the user asks for top 3 results, plan 3 goals to fetch each result and then a final goal to synthesise the results.\n"
    "Evaluate a concept that may lack a direct reference or keyword match in the given documents, plan an initial goal to access the web to learn about the concept or question quickly so you can subsequently search the documents for indirect or conceptual matches."
    "Procedure:\n"
