...
SYSTEM = (
    ...
    "  search_knowledge tool is based on embedding vector search, so if a direct key word search didn't give a good result then try to search via semantic meaning "
)
